...
--
-- Host: localhost
-- Generation Time: Apr 29, 2023 at 12:18 AM
...
CREATE TABLE `doctor` (
  ...
  `worktime` varchar(300) NOT NULL,
  `pricing` varchar(500) NOT NULL,
  `dq` varchar(500) NOT NULL,
...
('root', '2023-04-28 22:18:22', '{\"Console\\/Mode\":\"show\",\"Console\\/Height\":477.00200000000000954969436861574649810791015625}');
